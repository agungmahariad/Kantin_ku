...
<body>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li><a href="<?php echo base_url('c_filter_penerimaan/dashboard'); ?>">Dashboard</a></li>
                            <li><a href="<?php echo base_url('c_filter_penerimaan/kategori'); ?>">Input Kategori</a></li>
                            <li><a href="<?php echo base_url('c_filter_penerimaan/makanan'); ?>">Input Makanan</a></li>
                            <li><a href="<?php echo base_url('c_filter_penerimaan/pemasok'); ?>">Input Pemasok</a></li>
                            <li><a href="<?php echo base_url('c_filter_penerimaan/barang') ?>">Input Barang</a></li>
                            <li>
                            	...
                            	<ul class="dropdown-menu" style="background-color: grey;"	>
    								<li><a href="<?php echo base_url('c_filter_penerimaan/penerimaan'); ?>">Penerimaan</a></li>
    								<li><a href="<?php echo base_url('c_filter_penerimaan'); ?>">Filterisasi & Laporan</a></li>
  								</ul>
                            </li>
                            ...
                            <li>
                            	...
                            	<ul class="dropdown-menu" style="background-color: grey;"	>
    								<li><a href="<?php echo base_url('c_filter_penerimaan/pengeluaran'); ?>">Pengeluaran</a></li>
    								<li><a href="<?php echo base_url('c_filter_penerimaan/filter_pengeluaran'); ?>">Filterisasi & Laporan</a></li>
  								</ul>
                            </li>
                            <li><a href="<?php echo base_url('c_filter_penerimaan/logout'); ?>">Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <form method="post" action="<?php echo base_url('c_filter_penerimaan/filter'); ?>">
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line" style="color: #0089FE; border-color: #0089FE;">Filterisasi Penerimaan Uang</h1>
                </div>
            </div>
            <!-- FORM INPUT KATEGORI -->
            ...
            <div class="row" style="margin: auto;">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <hr>
                        <button class="btn btn-info"><span class="glyphicon glyphicon-send"></span> &nbsp;Filter</button>&nbsp;
                    </div>
                </div>
            </div>
    </form>
                    ...
                    <?php else: ?>
                        ...
                        <?php if ($gagal): ?>    
                            <div class="alert alert-danger">
                                <span>Tidak ada data yang di filter !</span>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <div class="panel-body">
                ...
                <form method="post" action="<?= base_url('c_filter_penerimaan/excel') ?>">
